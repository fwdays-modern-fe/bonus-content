...
import { NextJsServerFunctions } from "../constructs/next-js-server-functions";
...
export class NextJsStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props: Props) {
    ...
    const serverFunction = new NextJsServerFunctions(this, "ServerFunction", {
      assetsBucket,
      openNextServerDir: path.join(props.path, ".open-next/server-functions/default"),
    });
